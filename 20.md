...
Quote locks are mandatory on keysets with version byte `02` or later: a mint **MUST** reject minting an unlocked quote onto such a keyset ([NUT-04](04.md#taproot-transactions-v3-keysets)). The pre-v3 message format is specified in [legacy NUT-20](legacy/20.md).
