...
For keysets with version byte `02` or later, `Proof.secret` is a compressed secp256k1 public key encoded as 66 lowercase hex characters ([NUT-10 Taproot secrets](10.md#taproot-secrets-v3-keysets)), and `P` is its **decoded 33 bytes**.
